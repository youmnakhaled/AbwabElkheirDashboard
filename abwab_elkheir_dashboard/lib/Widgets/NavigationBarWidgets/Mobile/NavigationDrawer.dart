...
import 'package:abwab_elkheir_dashboard/Views/AddCasesScreen.dart';
...
class _NavigationDrawerState extends State<NavigationDrawer> {
  ...
  Widget build(BuildContext context) {
    ...
    var children2 = <Widget>[
      ...
      //         dateTimeRange == null
      //             ? 'N/A'
      //             : arabicNumber.convert(dateTimeRange.start.day.toString() +
      //                 ' - ' +
      ...
      //         dateTimeRange == null
      //             ? 'N/A'
      //             : arabicNumber.convert(dateTimeRange.end.day.toString() +
      //                 ' - ' +
      ...
      //           setState(() {
      //             casesViewModel.setStartDate(dateTimeRange.start.toString());
      ...
      ListTile(
        onTap: () {
          context.vRouter.push("/setting");
        },
        title: Text(
          '  اعدادت الصفحة الرئيسية',
          style: TextStyle(fontSize: 18, fontWeight: FontWeight.normal),
        ),
        trailing: Icon(
          Icons.settings,
